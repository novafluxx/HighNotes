...
- **Frontend**: Nuxt 4 (TypeScript + Vite)
- **Backend**: Supabase (Auth, Realtime, Postgres)
- **Editor**: TipTap rich-text editor
- **Styling**: Nuxt UI 4 + Tailwind CSS 4
...
- `package.json` - Dependencies and scripts (pnpm@10.22.0)
...
- Check IndexedDB stores (`notes` and `queue`)
